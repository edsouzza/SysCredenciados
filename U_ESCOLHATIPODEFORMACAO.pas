...
type
  TF_ESCOLHATIPODEFORMACAO = class(TForm)
    ...
    procedure ListaDeTiposDeFormacao;
...
begin
     ...
     ListaDeTiposDeFormacao;

end;

procedure TF_ESCOLHATIPODEFORMACAO.ListaDeTiposDeFormacao;
begin
     ...
     begin
           ...
           begin
              Application.MessageBox('No momento não existem arquitetos ativos!',
     ...
     begin
           ...
           if DM.CDS_CONSULTAS.RecordCount = 0 then
           begin
              Application.MessageBox('No momento não existem contadores ativos!',
                 'Tabela vazia!', MB_OK + MB_ICONINFORMATION);
              close;
     ...
     begin
           ...
           if DM.CDS_CONSULTAS.RecordCount = 0 then
           begin
              Application.MessageBox('No momento não existem engenheiros ambientais ativos!',
                 'Tabela vazia!', MB_OK + MB_ICONINFORMATION);
              close;
    ...
    begin
           ...
           if DM.CDS_CONSULTAS.RecordCount = 0 then
           begin
              Application.MessageBox('No momento não existem engenheiros civis ativos!',
                 'Tabela vazia!', MB_OK + MB_ICONINFORMATION);
              close;
